defmodule BookTracker.AuthorsTest do
  ...
  describe "authors" do
    ...
    test "create_author/1 with valid data creates a author" do
      valid_attrs = %{first_name: "some first_name", last_name: "some last_name", bio_notes: "some bio_notes"}
    ...
    test "update_author/2 with valid data updates the author" do
      author = author_fixture()
      update_attrs = %{first_name: "some updated first_name", last_name: "some updated last_name", bio_notes: "some updated bio_notes"}
