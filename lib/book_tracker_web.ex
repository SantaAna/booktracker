  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: BookTrackerWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {BookTrackerWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: BookTrackerWeb.Router,
        statics: BookTrackerWeb.static_paths()
    end
  end
